...
def create_rag_pipeline():
    try:
        ...
        if os.path.exists("faiss_store"):
            ...
            medical_json_loader = JSONLoader(file_path="data/chatdoctor5k 1.json",
                                        jq_schema = jq_schema,
                                        text_content = False
                                        )
            ...
            medical_csv_loader = CSVLoader(file_path="data/format_dataset 1.csv")
        ...
        llm = ChatGoogleGenerativeAI(model = "gemini-2.5-flash-lite", google_api_key=os.getenv("GOOGLE_API_KEY"), max_output_tokens = 4000,temperature = 0.7)
